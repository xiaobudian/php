...
ALTER TABLE question ADD COLUMN content_txt longtext NOT NULL;
ALTER TABLE answer ADD COLUMN content_txt VARCHAR(1000) NOT NULL;
ALTER TABLE question MODIFY content_txt VARCHAR(1000) NOT NULL;
ALTER TABLE question ADD COLUMN modifytime DATETIME;
ALTER TABLE answer CHANGE answer content NVARCHAR(2000) NOT NULL;
ALTER TABLE answer MODIFY accepted TINYINT(1) NOT NULL DEFAULT 0;
